...
double __device__ add1_divice(const double x, const double y);
double __device__ add3_divice(const double x, const double y, double &z);
double __device__ add2_divice(const double x, const double y , double *z);
